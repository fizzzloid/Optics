...
public:
    ...
    {
        ray_options->setWindowTitle(QApplication::translate("ray_options", "Ray's options", Q_NULLPTR));
        angle_groupbox->setTitle(QApplication::translate("ray_options", "&Geometry", Q_NULLPTR));
        right_btn->setText(QApplication::translate("ray_options", "Right (D)", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        right_btn->setShortcut(QApplication::translate("ray_options", "D", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        up_btn->setText(QApplication::translate("ray_options", "Up (W)", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        up_btn->setShortcut(QApplication::translate("ray_options", "W", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        left_btn->setText(QApplication::translate("ray_options", "Left (A)", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        left_btn->setShortcut(QApplication::translate("ray_options", "A", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        down_btn->setText(QApplication::translate("ray_options", "Down (S)", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        down_btn->setShortcut(QApplication::translate("ray_options", "S", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        ccv_btn->setText(QApplication::translate("ray_options", "CCV (Q)", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        ccv_btn->setShortcut(QApplication::translate("ray_options", "Q", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        cv_btn->setText(QApplication::translate("ray_options", "CV (E)", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        cv_btn->setShortcut(QApplication::translate("ray_options", "E", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        x_spin_box->setPrefix(QApplication::translate("ray_options", "x = ", Q_NULLPTR));
        y_spin_box->setPrefix(QApplication::translate("ray_options", "y = ", Q_NULLPTR));
        color_group_box->setTitle(QApplication::translate("ray_options", "&Color", Q_NULLPTR));
        red_label->setText(QApplication::translate("ray_options", "&Red", Q_NULLPTR));
        green_label->setText(QApplication::translate("ray_options", "&Green", Q_NULLPTR));
        blue_label->setText(QApplication::translate("ray_options", "&Blue", Q_NULLPTR));
        color_preview->setText(QString());
        delete_button->setText(QApplication::translate("ray_options", "Delete", Q_NULLPTR));
        reset_btn->setText(QApplication::translate("ray_options", "&Reset", Q_NULLPTR));
    } // retranslateUi
